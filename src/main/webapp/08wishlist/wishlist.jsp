...
request.setAttribute("wishlistDtos", filteredList);
;
            ...
            <div class="left">
               ...
               <div id="menu">
                  <ul>
                     ...
                     <li id="sub_menu">회원정보
                        <ul>
                           <li><a href="/00BookJSP/07users/updateUser.jsp">회원정보
                                 수정</a></li>
                           <li>로그인 설정</li>
                           <li>마케팅 수신 설정</li>
                           ...
                           <li>
                              ...
                              <div class="buttons">
                                 <button type="button" class="wishlist-btn"
                                    data-book-id="${wish.book_id}"
                                    onclick="toggleWishlist(this)">🤍 찜하기</button>
                                 <button type="button" class="cart-btn"
                                    data-book-id="${wish.book_id}" onclick="toggleCart(this)">🛒
                                    장바구니</button>
                              </div>
                           </li>
                        </c:forEach>
...
detailBtns.forEach(btn => {
  btn.addEventListener('click', function (e) {
    e.preventDefault(); // 기본 submit 잠깐 멈춤
